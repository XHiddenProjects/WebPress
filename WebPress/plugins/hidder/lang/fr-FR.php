...
$lang[$plugin.'isHideMod'] = '<i class="fa-solid fa-triangle-exclamation"></i> Ce message est pour les modérateurs !';
$lang[$plugin.'isHideUser'] = '<i class="fa-solid fa-triangle-exclamation"></i> Ce message est pour un utilisateur spécifique !';
?>