	...
	!defined('MAINDIR') ? (basename(__DIR__)==='htdocs' ? define('MAINDIR', DS) : define('MAINDIR', basename(__DIR__))) : '';
	...
	!defined('PROJECT_BUILD') ? define('PROJECT_BUILD', '230401 <span class="text-secondary" style="font-size:12px;">'.date('d (F) Y', strtotime('23-04-01')).'</span>') : '';
