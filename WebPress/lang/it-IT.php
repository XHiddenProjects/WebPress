...
'dashboard.side.utils'=>'Utilità <i class="fa-solid fa-wrench"></i>',
'dashboard.side.advanced'=>'Avanzate <i class="fa-solid fa-user-lock"></i>',
'dashboard.side.other'=>'Aggiungi su <i class="fa-solid fa-circle-plus"></i>',
